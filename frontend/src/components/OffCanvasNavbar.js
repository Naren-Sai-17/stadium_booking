...
export default function OffCanvasNavbar() {
    ...
    return (
        <>
            <div id='menu' className=' z-10 bg-slate-800 fixed w-1/4 justify-around h-screen -right-full Transition'>
                <section>
                ...
                <div className='px-8 py-2 lg:text-xl'>
                    ...
                    <Link to='/profile'>
                        <div className='grid grid-cols-3 border-0 py-2 mt-14 px-2 btn
                    ...
                    <Link to='/orders'>
                        <div className='grid grid-cols-3 py-2 mt-6 text-center px-2 btn
                        bg-slate-300 rounded-md hover:bg-slate-100'>
                            <AiOutlineShoppingCart className='h-6 w-6 lg:h-10 lg:w-10 icon' />
                            <div className='flex justify-left my-auto col-span-2' >Your Orders</div>
                        </div>
                    </Link>
