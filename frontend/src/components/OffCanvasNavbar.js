            ...
            <div id='menu' className=' z-20 bg-slate-800 fixed sm:w-[40%] md:w-[35%] lg:w-1/4 w-screen justify-around sm:h-screen -right-full Transition'>
                ...
                <div className='px-8 py-2 xl:text-xl'>
                    <span className='text-white xl:text-2xl mt-2'>
                        Hi, { (contextData.user != null && contextData.user != 'null') ? `${ localStorage.getItem('username') }` : `Guest` }
                    </span>
                    ...
                    <Link to='/orders' className={ (contextData.user != null) ? `block` : `hidden`}>
                        <div className='md:mb-[20%] grid grid-cols-3 py-2 mt-6 text-center whitespace-nowrap px-2 mx-[10%] sm:mx-0 btn
                        bg-slate-300 rounded-md hover:bg-slate-100'>
                    ...
                    <Link to='/login' className={ (contextData.user === null) ? `block` : `hidden`}>
                        <div className='grid grid-cols-3 border-0 py-2 mt-8 md:mt-14 px-2 mx-[10%] sm:mx-0 btn
                        bg-slate-300 rounded-md hover:bg-slate-100'>
                            <TbLogin2 className='h-6 w-6 lg:h-10 lg:w-10 icon' />
                            <div className='flex justify-center my-auto hover:border-orange-400' >Login</div>
                        </div>
                    </Link>
                    
                    <Link to='/events'>
                        <div className='md:hidden grid grid-cols-3 py-2 mt-6 mb-[20%] md:mb-[0%] text-center px-2 mx-[10%] sm:mx-0 btn
                        bg-slate-300 rounded-md hover:bg-slate-100'>
                            <MdOutlineSportsCricket className='h-6 w-6 lg:h-10 lg:w-10 icon' />
                            <div className='flex justify-center my-auto hover:border-orange-400' >Events</div>
                        </div>
                    </Link>
