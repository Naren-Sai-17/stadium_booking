                            ...
                            <form onSubmit={ handleSubmit }>
                                <div className="text-center">
                                    ...
                                    <div className=" flex flex-col items-center gap-3 pt-5">
                                        ...
                                        <input className="w-3/4 shadow appearance-none border rounded py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="password" type={type} value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Password" />
