...
<div className="flex flex-wrap">
    <div className="w-full md:w-1/2 lg:w-1/4 px-4 mb-8 ">
        <div className="card">
            ...
            <div className="p-4">
                <h2 className="text-xl font-bold">Naren Sai</h2>
                <p className="text-sm text-gray-600">https://github.com/Naren-Sai-17</p>
    ...
    <div className="w-full md:w-1/2 lg:w-1/4 px-4 mb-8">
        <div className="card">
            ...
            <div className="p-4">
                ...
                <p className="text-sm text-gray-600">https://github.com/Hi-TechMissile</p>
    ...
    <div className="w-full md:w-1/2 lg:w-1/4 px-4 mb-8">
        <div className="card">
            ...
            <div className="p-4">
                ...
                <p className="text-sm text-gray-600">https://github.com/Ruthvik283</p>
    ...
    <div className="w-full md:w-1/2 lg:w-1/4 px-4 mb-8">
        <div className="card">
            ...
            <div className="p-4">
                ...
                <p className="text-sm text-gray-600">https://github.com/Neerupam2772</p>
