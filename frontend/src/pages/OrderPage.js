...
const OrderPage = () => {
    ...
    const [orders, setOrders] = useState([
        // Each booking is of the following type.
        {
            booking_id: 0,
            event_name: "",
            tickets: [],
    ...
    function handleDownload(booking_id) {
        // console.log("Button clicked... waiting for booking #", booking_id)
            axios({
                                        ...
                                        <ul className="md:flex flex-wrap border-0 grid grid-cols-2 md:grid-cols-none">
                                            {order.tickets.map((ticket) => (
                                                <li
                                                    ...
                                                    className={ `m-2 p-2 md:p-4 border-2 border-gray-300 min-w-[75px] md:min-w-[150px] hover:bg-opacity-90 rounded-lg ${category[ticket.sector_name] ?? `bg-blue-800`} flex flex-col justify-between` }
                                                >
